// Reflection is the ability of inspecting an assemblie's metadata at runtime.  It is used to find all types in an assembly and/or dynamically invoke methods in an assembly. This includes information about the type, properties, methods, and events of an object.
...
// Late binding can be achieved by using reflection.You can use reflection to dynamically create an instance of a type, about which we don't have any information at compile time
...
namespace Ram
{
    public class MainClass
    {
        private static void Main()
        {
            ...
            Type T = Type.GetType("Pujan.Customer");
